...
const ExploreMore = () => {
  ...
  return (
    <div>
      ...
      <div className='flex flex-row rounded-full bg-richblack-800 mb-5 border-r border-richblack-100
      px-1 py-1'>
        {
            tabsName.map((element,index) => {
                return(
                    ...
                    ${currentTab === element ? "bg-richblack-900 text-richblack-5 font-medium" :
                        "text-richblack-200"} rounded-full transition-all cursor-pointer
